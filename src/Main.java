public class Main {
    public static void main(String[] args) {
		...
		*/
        ...
        Recording { name=Giant Steps, artist=John Coltrane, year=1959, type=LP, condition=10, original price=100.0, price=420.0, price+vat=525.0 }
        Recording { name=Kind of Blue, artist=Miles Davis, year=1959, type=CD, condition=5, original price=100.0, price=50.0, price+vat=62.5 }
		...
		*/
        ...
        Receipt for order #3
        -----------
        Recording { name=Punisher, artist=Phoebe Bridgers, year=2020, type=CD, condition=10, original price=200.0, price=200.0, price+vat=250.0 }
        Recording { name=What Kinda Music, artist=Tom Misch, year=2020, type=LP, condition=10, original price=150.0, price=165.0, price+vat=206.25 }
        Recording { name=Little Oblivions, artist=Julien Baker, year=2021, type=LP, condition=10, original price=120.0, price=130.0, price+vat=162.5 }
